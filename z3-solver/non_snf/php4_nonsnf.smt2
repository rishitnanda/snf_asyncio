...
;
; Clause count: 5 big-OR clauses (row coverage)
;            + 40 pairwise exclusion clauses
; vs SNF structured: 9 linear constraints total

(set-logic QF_LIA)

; 5x4 = 20 assignment variables (0/1 Int)
...
(assert (or (= a00 1) (= a01 1) (= a02 1) (= a03 1)))
(assert (or (= a10 1) (= a11 1) (= a12 1) (= a13 1)))
(assert (or (= a20 1) (= a21 1) (= a22 1) (= a23 1)))
(assert (or (= a30 1) (= a31 1) (= a32 1) (= a33 1)))
(assert (or (= a40 1) (= a41 1) (= a42 1) (= a43 1)))
